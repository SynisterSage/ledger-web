...
export function McpAuthorizationPage({ requestId }: { requestId: string }) {
  ...
  if (state === 'done') return <IntegrationCallbackSuccess variant="completion" sourceName="MCP authorization" sourceIcon="/assets/logos/logo.svg" title="Connection approved" description="Your AI client can now return to Ledger and continue with the authorized workspace." />
