...
export const getDesktopCssVars = (scheme: DesktopThemeScheme = 'light'): Record<string, string> => {
  ...
  return {
    ...
    '--ledger-header-background': isDark ? 'rgba(12, 12, 14, 0.92)' : 'rgba(18, 18, 20, 0.92)',
    '--ledger-header-background-scrolled': isDark ? 'rgba(10, 10, 12, 0.96)' : 'rgba(14, 14, 16, 0.96)',
    '--ledger-header-border': 'rgba(255, 255, 255, 0.08)',
    '--ledger-header-rule': isDark ? 'rgba(255, 255, 255, 0.10)' : 'rgba(255, 255, 255, 0.12)',
    '--ledger-header-text': 'rgba(255, 255, 255, 0.94)',
    '--ledger-header-text-muted': 'rgba(255, 255, 255, 0.68)',
    '--ledger-header-pill': 'rgba(255, 255, 255, 0.08)',
    '--ledger-header-pill-active': 'rgba(255, 255, 255, 0.14)',
    '--ledger-header-shadow': isDark ? 'rgba(0, 0, 0, 0.42)' : 'rgba(0, 0, 0, 0.36)',
